    ...
    public static void main(String[] args) {
        ...
        switch (status) {
            ...
            case 3: if (income <= 11950) {
                        ...
                        tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (82250 - 45500) * 0.25 + (income - 82250) * 0.28;
                    } else if (income <= 372950) {
                        tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (82250 - 45500) * 0.25 + (190200 - 82250) * 0.28 + (income - 171550) * 0.33;
                    } else {
                        tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (82250 - 45500) * 0.25 + (190200 - 82250) * 0.28 + (372950 - 171550) * 0.33 + (income - 372950) * 0.35;
                    };
                    break;
